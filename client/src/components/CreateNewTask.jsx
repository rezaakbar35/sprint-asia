...
import { createTask } from "../../modules/fetch/task";
import { createToDo, getUserToDo } from "../../modules/fetch/todo";
import Cookies from "js-cookie";
import { jwtDecode } from "jwt-decode";

const CreateNewTask = ({ visible, onClose }) => {
      ...
      <div className="w-1/3 h-1/3 bg-[#FCF7E9] rounded-3xl">
        ...
        <form>
          <div className="grid grid-cols-2 mx-5">
            ...
            <div className="p-2">
              <div className="pb-5 px-2">
                <div onClick={toggleView} className="absolute ml-32 px-2 text-sm rounded-xl hover:cursor-pointer text-white bg-[#FFA86B]">change type</div>
